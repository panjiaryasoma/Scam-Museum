...
TITLE_RULES = [
    ({"OTP_REQUEST"}, "THE VERIFICATION TRAP"),
    ({"RISKY_ATTACHMENT"}, "THE DANGEROUS DOWNLOAD"),
    ...
    (
        {"INVESTMENT_OR_CRYPTO_PITCH", "OFF_PLATFORM_CONTACT_REQUEST"},
        "THE INVESTMENT INVITATION",
    ),
    (
        {"JOB_OR_TASK_SOLICITATION", "PIECE_RATE_TASK_PAYMENT"},
        "THE PAID TASK PITCH",
    ),
]
